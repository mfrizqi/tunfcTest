        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-10">
                    ...
                    <div>
                        <h1 class="text-white mt-5 menutitle text-right">TUNFC</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row justify-content-center p-0 mt-4 mx-1">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-item nav-link active semibold" href="index.html">Beranda<span class="sr-only">(current)</span></a>
            ...
            <div class="row justify-content-center content-v">
                <div class="col-10 col-md-8 tujuan">
                    ...
                    <div class="caption regular offset-l-10">
                        <p>Tujuan utama diselenggarakannya Telkom University National Futsal Championship (TUNFC) untuk menjalin dan memperkuat tali persaudaraan antar mahasiswa perguruan tinggi di Indonesia.</p>
                        <div class="space"></div>
                    </div>
                    <div class="caption regular offset-l-30">
                        <p>TUNFC juga memberikan pengalaman kepada mahasiswa untuk bersaing secara kompetitif di bidang futsal dan membantu melahirkan atlet-atlet futsal berkualitas yang nantinya diharapkan mampu mengharumkan nama Indonesia</p>
                    </div>
                </div>
                ...
                <div class="col-10 col-md-8 sejarah">
                    ...
                    <div class="caption regular offset-l-20">
                        <p>TUNFC pertama kali diselenggarakan pada tahun 2016 yang bertempat di Sigma Sport & Community Center – Progresif Football & Futsal Bandung. </p>
                    </div>
                    <div class="caption regular offset-l-30">
                        <div class="space"></div>

                        <p>Terbentuknya TUNFC di latar belakangi oleh UKM Bola Telkom University yang tak ingin selalu menjadi peserta kompetisi-kompetisi futsal tingkat nasional tetapi juga ingin menjadi penyelenggara kompetisi futsal tingkat nasional</p>
                ...
                <div class="col-10 col-md-8 dukungan">
                    ...
                    <div class="space"></div>
                    <div class="caption regular offset-l-20">
                        <p>Telkom University National Futsal Championship (TUNFC) selalu menghadirkan inovasi tak terduga tiap tahunnya. Terbukti pada tahun 2018, TUNFC berhasil menjalin kerjasama dengan Syahidan Lubis. Bambang Bayu Saptaji, Andri Kustiawan dan Bonsu Hasibuan kemudian berhasil digaet pada TUNFC 2019</p>
                    </div>
                </div>
                ...
                <div class="col-10 col-md-8 halloffame">
                    ...
                    <div id="HallImg"></div>
                    <div class="caption regular offset-l-30">
                        <p>Setiap penyelenggaraannya TUNFC selalu menghasilkan juara baru. Terbukti sejak awal berdiri hingga sekarang, belum pernah ada perguruan tinggi yang memenangkan TUNFC secara berturut
                        </p>
